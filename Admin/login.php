            ...
            <div class="login-form-container">
                <form action="" method="post" name="signupform">
                    <div class="login-form-wrapper">
                        ...
                        <div class="login-form-element-group">
                            <button name="loginbutton" class="button1"><a href="index.php">Login</a></button>

                            <!-- <a href="signup.php" style="color:#fff;text-decoration:none;font-family:verdana;margin-top:10px;">Not Registered Yet? <span style="color:var(--secondary)">Sign Up</span></a> -->
                        </div>
                    </div>
                </form>
            </div>
